...
<div class="pagetitle">
    ...
    <div class="row">
     <?php 
      ...
      $objDB = new Database;
      $userid = $_GET['id'];
      $reservation = "SELECT * FROM reservation WHERE status=0 ORDER BY created_at DESC";
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <form action="web/route.php" method="POST">
                    ...
                    <button class="btn btn-success float-end m-2" name="checkoutroom">Check Out</button>
                  </form>
                </div>
              </div>
            </div>
